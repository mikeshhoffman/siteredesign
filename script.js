...
google.charts.setOnLoadCallback(drawRenewableBtusChart);
google.charts.setOnLoadCallback(drawConsumedBtusChart);

function drawRenewableBtusChart(){
...
function drawConsumedBtusChart(){
  var data = google.visualization.arrayToDataTable([
      ['Year', 'Btus (billions)'],
      ['1960', 57344],
      ['1961', 62705],
  ...
  var options = {
    title: 'Aannual total electricity consumption in Florida',
    legend: { position: 'bottom' }
  };
